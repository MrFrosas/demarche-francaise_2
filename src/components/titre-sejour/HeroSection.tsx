      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-2xl md:text-fr-h1 font-bold text-france-text-dark mb-4 md:mb-6 text-center">
            Obtenez votre titre de séjour en France avec confiance et sérénité
          </h1>
          <p className="text-base md:text-fr-text-lg text-france-text mb-8 md:mb-12 text-center px-2 md:px-0">
            La recherche d'un titre de séjour peut être un parcours complexe et stressant. 
            Heureusement, nos experts sont là pour vous simplifier la vie. De la compréhension 
            des différentes catégories de titres de séjour à l'assistance dans la préparation 
            et le dépôt de votre dossier, nous vous accompagnons à chaque étape !
          </p>
