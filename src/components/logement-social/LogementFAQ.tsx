...
const faqs = [
  ...
  {
    question: "Combien de temps ai-je pour quitter la France après avoir reçu une OQTF ?",
    answer: "Le délai pour quitter la France varie en fonction de la décision individuelle et de la situation. Il est essentiel de respecter ce délai, car ne pas le faire peut avoir des conséquences légales graves, y compris la possibilité d'une expulsion forcée."
  },
  {
    question: "Combien de temps dure une téléconsultation typique ?",
    answer: "Nos téléconsultations durent généralement environ 30 minutes, mais la durée peut varier en fonction de la complexité de votre cas et de vos besoins spécifiques."
  }
];

export const LogementFAQ = () => {
